"""
Django settings for euni project.
...
SECRET_KEY = 'django-insecure-bi8eqa58(s9v-!b*bibh0-0_6#@$1po)$h+ke-6va)yr^&+zx_'
...
WSGI_APPLICATION = 'euni.wsgi.application'
...
if CASHFREE_ENV == 'PROD':
    CASHFREE_APP_ID = os.getenv('CASHFREE_PROD_APP_ID')
    CASHFREE_SECRET_KEY = os.getenv('CASHFREE_PROD_SECRET_KEY')
else:
